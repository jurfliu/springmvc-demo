...
/**
 * @ClassName: MyDefinedIntercepter
 * @Description: TODO
 * @Author: liujianfu
 * @Date: 2021/01/15 12:37:23 
 * @Version: V1.0
 **/
public class MyDefinedIntercepter implements HandlerInterceptor {
    /**
     * 预处理，controller方法执行前
    ...
    public void postHandle(HttpServletRequest request, HttpServletResponse response, Object handler, ModelAndView modelAndView) throws Exception {
        ...
        modelAndView.addObject("username","第一个intercepter");
        // request.getRequestDispatcher("/WEB-INF/pages/error.jsp").forward(request,response);
    }
